...
def main():
    ...
    # param_singleton.set_model_name('26_19_12_100_40_ycbm_yolov7x_01') # v7 model 
    # param_singleton.set_model_name('27_18_12_100_40_ycbv_yolov7x_01') # v7 model 
    # param_singleton.set_model_name('28_11_01_10_40_ycbm_ycbv_yolov7x_01') # v7 model 
    param_singleton.set_model_name('29_28_01_100_16_ycbv_ycbm_yolov8x_01') # v8 model 

    # yolov7_prediction = Yolov7Prediction()
    # yolov7_prediction.predict()

    mAPs = []
    # for i in range (0,10):  # yolov7
    for i in range (1,100): # yolov8
    ...
    # ----------- YOLOV8 for last.pt -------------
    yolov8_prediction = Yolov8Prediction()
    yolov8_prediction.set_weight_name("last.pt")
    yolov8_prediction.predict()
    metrics_calculation = MetricsCalcualtion()
    mAP = metrics_calculation.calculate_metrics(map_return=True)
    mAPs.append(mAP)
