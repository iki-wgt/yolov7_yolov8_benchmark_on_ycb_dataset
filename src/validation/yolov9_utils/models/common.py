...
from yolov9_utils.utils import TryExcept
from yolov9_utils.utils.dataloaders import exif_transpose, letterbox
from yolov9_utils.utils.general import (LOGGER, ROOT, Profile, check_requirements, check_suffix, check_version, colorstr,
...
from yolov9_utils.utils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolo.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False, fuse=True):
        ...
        from yolov9_utils.models.experimental import attempt_download, attempt_load  # scoped to avoid circular import
    ...
    def _model_type(p='path/to/model.pt'):
        ...
        from yolov9_utils.export import export_formats
        from yolov9_utils.utils.downloads import is_url
